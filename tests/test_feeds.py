...
from reporeaver.feeds import query_osv, query_malwarebazaar, get_known_c2_domains
...
class TestFeeds:
    ...
    @patch("reporeaver.feeds._get_cached", return_value=None)
    @patch("reporeaver.feeds.urllib.request.urlopen", side_effect=urllib.error.URLError("timeout"))
